 ...
 *
 * The pl_editor kiface is dlopen'd lazily, well after KICAD_API_SERVER::Start
 ...
 *   - Add the .cpp to PL_EDITOR_SRCS in pagelayout_editor/CMakeLists.txt.
 *   - Add one entry to klicad_register_pl_editor_bindings() in the .cpp.
 */
...
void klicad_register_pagelayout_bindings( pybind11::module_& m );
