 ...
 *
 * The pcbnew kiface is dlopen'd lazily, well after KICAD_API_SERVER::Start
 ...
 * function.  IFACE::OnKifaceStart calls klicad_register_pcbnew_bindings()
 ...
 *   - Add the .cpp to PCBNEW_SRCS in pcbnew/CMakeLists.txt.
 *   - Add one entry to klicad_register_pcbnew_bindings() in the .cpp.
 */
