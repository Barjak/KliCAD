 ...
 *
 * The gerbview kiface is dlopen'd lazily, well after KICAD_API_SERVER::Start
 ...
 * function.  IFACE::OnKifaceStart calls klicad_register_gerbview_bindings()
 ...
 *   - Add the .cpp to GERBVIEW_SRCS in gerbview/CMakeLists.txt.
 *   - Add one entry to klicad_register_gerbview_bindings() in the .cpp.
 */
...
void klicad_register_gerbview_bindings_impl( pybind11::module_& m );
...
void klicad_register_gerbview_bindings();
